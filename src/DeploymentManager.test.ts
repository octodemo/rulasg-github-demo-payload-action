...
import { EnvironmentDeployment, Repository } from './types';
...
describe('DeploymentManager', () => {
  ...
  before(() => {
    ...
    deploymentManager = new DeploymentManager(repo, octokit);
  });
  ...
  describe('demo deployments', () => {
    ...
    before('initialize test deployment', async () => {
      deployment = await deploymentManager.createDemoDeployment({
